#include "elliptics-fastcgi/lookup_result.hpp"
...
lookup_result_t::lookup_result_t(const ioremap::elliptics::lookup_result_entry &entry, bool eblob_style_path, int base_port, int directory_bit_num)
	: m_entry(entry)
